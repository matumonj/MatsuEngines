...
private:
	void TextBeha();
	XMVECTOR WDivi(const DirectX::XMVECTOR& pos, const DirectX::XMMATRIX& mat, const bool s);

	XMVECTOR WDivi(const DirectX::XMVECTOR& pos, const bool isWSlide);
	XMVECTOR PosDivi(const DirectX::XMVECTOR& pos, const DirectX::XMMATRIX& mat, const bool s);
private:
	XMFLOAT2 TexSize = {};
	float TexAlpha=0.0f;
