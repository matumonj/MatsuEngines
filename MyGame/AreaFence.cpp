...
bool AreaFence::CollideAreaFence()
{
	...
	AreaFenceOBB.m_fLength[0] = m_Object->GetMatScl().r->m128_f32[0];
	AreaFenceOBB.m_fLength[1] = m_Object->GetMatScl().r->m128_f32[1];//y方向の長さ
	AreaFenceOBB.m_fLength[2] = m_Object->GetMatScl().r->m128_f32[2]-2;//z方向の長さ
	//OBBの設定位置
