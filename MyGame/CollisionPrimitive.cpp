...
void OBB::SetOBBParam_Pos(DirectX::XMMATRIX posMat)
{
...
void OBB::SetOBBParam_Pos(DirectX::XMFLOAT3 pos)
{
	m_Pos.m128_f32[0] = pos.x;
	m_Pos.m128_f32[1] = pos.y;
	m_Pos.m128_f32[2] = pos.z;
}
void OBB::SetOBBParam_Scl(DirectX::XMFLOAT3 scl)
{
	m_fLength[0] = scl.x;
	m_fLength[1] = scl.y;
	m_fLength[2] = scl.z;
}
void OBB::SetOBBParam_Rot(DirectX::XMMATRIX rotMat)
{
