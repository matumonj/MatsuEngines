...
// ノード推論
NodeBase* NodeBase::Inference(Enemy* enemy, BehaviorDatas* data)
{
...
// オン・オフ
NodeBase* NodeBase::SelectOnOff(std::vector<NodeBase*>* list, BehaviorDatas* data)
{
...
// シーケンス
NodeBase* NodeBase::SelectSequence(std::vector<NodeBase*>* list, BehaviorDatas* data)
{
	// 今のノードのシーケンスのステップを取得
...
// ノード実行
EnemyActionBase::STATE NodeBase::Run(Enemy* enemy)
{
