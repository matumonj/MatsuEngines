...
void DirectXCommon::InitializeCommand()
{
	...
	//コマンドリストの生成
	result = dev->CreateCommandList(0, D3D12_COMMAND_LIST_TYPE_DIRECT, cmdAllocator.Get(), nullptr,
...
void DirectXCommon::InitializeSwapchain()
{
	...
	dxgiFactory->CreateSwapChainForHwnd(cmdQueue.Get(), winapp->GetHwnd(), &swapchainDesc, nullptr, nullptr,
	                                    &swapchain1);
...
void DirectXCommon::BeginDraw()
{
	...
	//描画先指定
	auto rtvH = CD3DX12_CPU_DESCRIPTOR_HANDLE(rtvHeaps->GetCPUDescriptorHandleForHeapStart(),
	                                          bbIndex, dev->GetDescriptorHandleIncrementSize(
	...
	//シザー短形の設定
	cmdList->RSSetScissorRects(1, &CD3DX12_RECT(static_cast<LONG>(0.0f), static_cast<LONG>(0.0f), static_cast<LONG>(wx),
	                                            static_cast<LONG>(wy)));
	ImguiDraw();
}
#pragma endregion
