...
bool MeshCollider::CheckCollisionSphere(const Sphere& sphere, XMVECTOR* inter, XMVECTOR* reject)
{
...
bool MeshCollider::CheckCollisionRay(const Ray& ray, float* distance, XMVECTOR* inter)
{
